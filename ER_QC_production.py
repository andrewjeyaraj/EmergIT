...
# Path to the chromedriver.exe in the same folder
chromedriver_path = os.path.join(current_dir, 'chromedriver.exe')

# Path to the Excel file (if writing or reading from one)
#excel_file_path = os.path.join(current_dir, 'emerg_timings.xlsx')  # Change 'output.xlsx' to the actual file name
...
driver_path = chromedriver_path #r'C:\Users\andre\Downloads\chromedriver-win64\chromedriver-win64\chromedriver.exe'
options = Options()
